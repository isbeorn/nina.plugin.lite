...
namespace WhenPlugin.When {
    ...
    [JsonObject(MemberSerialization.OptIn, Id = "WhenPlugin.When.ExternalScript")]

    public class ExternalScriptDeprecated : SequenceItem, IValidatable {
        public System.Windows.Input.ICommand OpenDialogCommand { get; private set; }

        public ExternalScriptDeprecated() {
        }

        private ExternalScriptDeprecated(ExternalScriptDeprecated cloneMe) : this() {
            CopyMetaData(cloneMe);
        }

        public override object Clone() {
            return new ExternalScriptDeprecated(this) {
                Script = Script
            };
        }
